...
const statusMeta = {
  verified: {
    ...
    Icon: BadgeCheck,
    cardClasses:
      'border-slate-200/90 border-l-[6px] border-l-emerald-600 bg-emerald-50/20 hover:bg-emerald-50/40 hover:border-emerald-300',
    badgeClasses: 'bg-emerald-700 text-white border-emerald-800 ring-1 ring-emerald-800 font-bold',
    badgeTextClass: 'text-white',
    iconColor: 'text-emerald-100',
    evidenceBoxClasses: 'border-emerald-300 bg-emerald-50 text-emerald-950',
    evidenceBorderClass: 'border-emerald-200/80',
  ...
  pending: {
    ...
    Icon: Clock,
    cardClasses:
      'border-slate-200/90 border-l-[6px] border-l-amber-500 bg-amber-50/20 hover:bg-amber-50/40 hover:border-amber-300',
    badgeClasses: 'bg-amber-600 text-white border-amber-700 ring-1 ring-amber-700 font-bold',
    badgeTextClass: 'text-white',
    iconColor: 'text-amber-100',
    evidenceBoxClasses: 'border-amber-300 bg-amber-50 text-amber-950',
    evidenceBorderClass: 'border-amber-200/80',
  ...
  disputed: {
    ...
    Icon: AlertTriangle,
    cardClasses:
      'border-slate-200/90 border-l-[6px] border-l-rose-600 bg-rose-50/20 hover:bg-rose-50/40 hover:border-rose-300',
    badgeClasses: 'bg-rose-700 text-white border-rose-800 ring-1 ring-rose-800 font-bold',
    badgeTextClass: 'text-white',
    iconColor: 'text-rose-100',
    evidenceBoxClasses: 'border-rose-300 bg-rose-50 text-rose-950',
    evidenceBorderClass: 'border-rose-200/80',
    tagClass: 'bg-rose-100 text-rose-900 border-rose-300',
  },
  flagged: {
    label: 'Needs Review',
    variant: 'destructive' as const,
...
const relevanceMeta = {
  directly_related: {
    ...
    variant: 'success' as const,
    badgeClasses: 'bg-emerald-50 text-emerald-900 border-emerald-300 font-semibold',
  },
  partially_related: {
    label: 'Partially Related',
    variant: 'warning' as const,
    badgeClasses: 'bg-amber-50 text-amber-900 border-amber-300 font-semibold',
  },
  unrelated: {
    label: 'Unrelated Sector',
    variant: 'neutral' as const,
    badgeClasses: 'bg-slate-100 text-slate-700 border-slate-300 font-semibold',
  },
}
